 ...
 */
package enterprise.classa.project.ktp.coba;

import enterprise.classa.project.ktp.coba.exceptions.NonexistentEntityException;
import enterprise.classa.project.ktp.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("enterprise.classa_project.ktp_jar_0.0.1-SNAPSHOTPU");
