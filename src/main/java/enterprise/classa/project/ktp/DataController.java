 ...
 */
package enterprise.classa.project.ktp;

import enterprise.classa.project.ktp.exceptions.NonexistentEntityException;
...
public class DataController {
    ...
    @PostMapping(value = "/prosestambah", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public RedirectView prosestambah(HttpServletRequest request, @RequestParam("foto") MultipartFile file) throws ParseException, IOException, Exception {
        Data data = new Data();
